...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($data === null) {
        ...
        exit(json_encode(["status" => "ERROR", "message" => "Некоректни данни!"]));
    }
    ...
    try {
        ...
        $sql = "INSERT INTO history (user_id, document, extension, filename, created_at) VALUES (:user_id, :document, :extension, :filename, NOW())";
